...
def main():
 ...
 required=("VERSION","packaging/pyinstaller/sus_adb.spec","packaging/common/generate_build_info.py","packaging/common/release_assets.py","packaging/common/verify_dist.py",".github/workflows/test.yml",".github/workflows/package.yml","release/RC3_CHECKLIST.md","release/RC3_PUBLICATION_PLAN.md","release/RELEASE_NOTES_1.0.0_RC3.md");ok=all((ROOT/p).exists() for p in required) and ok
