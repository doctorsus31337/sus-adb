...
def main():
 with tempfile.TemporaryDirectory() as d,isolated_smoke_environment(d):
  ...
  assert app.workspace_controller.current=="Home"
  ...
  app.workspace.set("Pentest");app.go_home();assert app.workspace.get()=="Home";assert center.winfo_exists()
