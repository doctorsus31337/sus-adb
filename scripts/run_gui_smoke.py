...
def main():
 with tempfile.TemporaryDirectory() as d:
  ...
  view=top.nametowidget(top.entrycget(cascades[labels.index("View")],"menu"));view_labels=[view.entrycget(i,"label") for i in range(view.index("end")+1) if view.type(i)=="command"];assert view_labels==["Home","Console","Instrumentation","Script Studio","Pentest"]
