...
def main():
 with tempfile.TemporaryDirectory() as d:
  ...
  app.command_bar.open_session_button.invoke();app.update_idletasks();sessions=app.sessions_center;assert sessions is app.open_sessions_center();assert sessions.routed_plan.session_type.value=="adb-shell";assert not app.interactive_sessions.list();assert no_question_help(sessions);sessions.close();assert app.sessions_center is None
