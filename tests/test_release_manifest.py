...
class ReleaseManifestTests(unittest.TestCase):
    ...
    def make_package(self, directory, selected=None):
        ...
        official_names=("device_rescue_recovery","rootability_advisor","webview_security_inspector","skeleton_module","frida_tutorial","objection_tutorial","logcat_investigator")
    ...
    def test_zero_curated_assets_passes_and_reports_categories(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(result["assets"]["official_bundled_plugins"]["count"], 7)
