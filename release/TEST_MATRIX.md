...
| Linux package | Immutable-source one-folder build, publication archive, required resources, curated-asset report, manifest, checksums, CLI, GUI, and privacy audit | Local RC4 gate plus GitHub Actions |
...
| Windows UI/argv regressions | Destroyed-widget focus lifecycle, rapid add-on state changes, terminal argv, and paths with spaces | CI: Windows |
