...
class Plugin:
    def activate(self,api):self.api=api;return (Contribution("rootability.dashboard","dashboard-card","Rootability Advisor",factory=panel_spec),Contribution("rootability.panel","pentest-panel","Rootability Advisor",factory=panel_spec,metadata={"ui_mode":"hybrid","singleton":True,"embedded_summary":True}),Contribution("rootability.menu","menu-action","Open Rootability Advisor",metadata={"target":"rootability.panel"}),Contribution("rootability.report","report-section","Bootloader Readiness",factory=report_section,capability_requirement="contribute-report-section"),Contribution("rootability.finding","finding-template","Device Hardening Observation"))
