...
class SusADBWindow(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.device_panel = DevicePanel(left, self.theme, self.refresh_devices, self.connect_device)
        ...
        self.console.insert("end", "[INFO] SUS-ADB Companion initialized.\\n")
    ...
    def refresh_devices(self):
        ...
        self.log(f"[ADB] Found {len(devices)} device(s).")
