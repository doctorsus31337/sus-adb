...
class ContributionRegistry:
    def __init__(self):self._items={};self._listeners=[]
    ...
    def register(self,plugin_id,contributions):
        ...
        try:
            ...
            result=tuple(self._items[i] for i in added);self._changed();return result
        except Exception:
