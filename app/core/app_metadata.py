...
class AppMetadata:
    application_name:str="SUS-ADB Companion";version:str="1.0.0-rc.1";release_channel:str="rc";build_identifier:str="rc1";repository_revision:str="unknown";build_timestamp:str="reproducible";python_version:str=platform.python_version();platform_name:str=platform.system();architecture:str=platform.machine();plugin_api_version:str="1.0";configuration_schema_version:int=3;case_workspace_schema_version:int=1
    @property
